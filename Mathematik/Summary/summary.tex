...
\begin{minipage}{.5\textwidth}
    ...
    f'(x)=\lim_{\Delta x\to 0}\frac{f(x+\Delta x)-f(x)}{\Delta x}
    \]
    berechnet. Dieser Grenzwert entspricht der exakten Steigung der Tangente an die Funktion f im Punkt x.
\end{minipage}
\hspace{0.1\textwidth}
...
\noindent In einzelnen Etappen darstellt sieht das folgendermassen aus: \\
