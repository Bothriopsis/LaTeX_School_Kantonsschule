...
% Title
\title{\Huge\textbf{Zusammenfassung - Mathematik}}
...
\section{Lösungen}
\begin{enumerate}
    \item Die Ableitung einer Funktion gibt die Steigung der Funktion an. Die Stammfunktion einer Funktion gibt die Fläche unter dem Graphen der Funktion an. Die Ableitung ist die Gegenfunktion der Stammfunktion und umgekehrt. Die Ableitung einer Funktion $f(x)$ ist die Funktion $f'(x)$, die die Steigung der Funktion $f(x)$ an jeder Stelle $x$ angibt. Die Stammfunktion einer Funktion $f(x)$ ist die Funktion $F(x)$, die die Fläche unter dem Graphen der Funktion $f(x)$ angibt.
    \item 
    \begin{multicols}{2}
        \begin{enumerate}[label=(\alph*)]
            \item $f'(x) = 6x + 5$
            \item $f'(x) = 8x\cos(4x^2) + 9x^2$
            \item $f'(x) = -\frac{2}{x^3}$
            \item $f'(x) = -\frac{5}{2x^3}$
            \item $f'(x) = 3e^{3x}$
            \item $f'(x) = \frac{2}{x}$
        \end{enumerate}
    \end{multicols}
    \item Ausgegangen von links nach rechts und dann gleich unten weiter gehören zusammen: (a) und (e), (b) und (c), (d) und (f).
\end{enumerate} 
\end{document}