...
\begin{wrapfigure}{r}{0.4\textwidth}
    \centering
    \includegraphics[width=.95\linewidth]{resources/images/Fotos/Physik-86.jpg}
    \caption{\raggedright{Magnet-Stelleinheit}}
    \label{fig:magnet}
\end{wrapfigure}
