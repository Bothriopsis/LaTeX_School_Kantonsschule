...
\begin{enumerate}
    \item Eine Weinkiste wurde als Gehäuse für den Lautsprecher selbst werwendet. Diese wurde an den Ecken isoliert und es musste eine passende Deckplatte zugeschnitten werden.
    \item Zwei Membranen wurden aus Schleifpapier ausgeschnitten und verklebt. Dabei wurden zwei unterschiedliche Grössen gewählt. Für den Hochtöner wurde eine kleine Membran gewählt und für den Tieftöner eine grössere.
    \item Die Spule wurde aus einem Karton gebaut. Dabei wurde der Karton in Streifen geschnitten und um einen Zylinder gewickelt. Dieser wurde dann mit Kupferdraht umwickelt und während dem Wickeln mit dem Ofenschnurkleber für jede Schicht angeklebt, da er sehr zähflüssig ist und nicht zwischen die Schichten fliessen kann.
    Es wurden 2 Suplen gebaut. Eine für den Hochtöner und eine für den Tieftöner.
    \item Die nun fertigen Spulen wurden jeweils an die passende Membran geklebt.
